...
| Browser Use community | Browser-agent practitioners | `https://github.com/browser-use/browser-use/discussions/4816` | Posted | Integration-focused feedback ask | Monitor comments | Lead with Browser Use trace/debug feedback; no comments yet |
| Stagehand community | Browser automation and agent builders | `https://github.com/browserbase/stagehand/discussions/2102` and `https://discord.gg/stagehand` | Posted | Adapter feedback ask | Monitor comments | Lead with Stagehand + Playwright local tracing; no comments yet |
...
| Skyvern users | Browser automation agent users | `https://github.com/Skyvern-AI/skyvern/discussions/5931` | Posted | Adapter request and issue link | Monitor comments | Avoid hijacking unrelated threads; no comments yet |
...
| AgentKart | Open-source AI agent marketplace visitors | `https://www.agentkart.ai/submit` | Day 2 or 4 | Directory submission | Owner login likely required | Submit Agent form asks for agent name, description, and GitHub repository; skip if only runnable autonomous agents are accepted |
| Agent Hub | People browsing AI agents, MCPs, and skills | `https://agent-hub.dev/` | Day 4 | Directory suggestion | No public route found | Blocked: no visible submit/contact route; revisit only if a public submission route appears |
| AgDex | AI agent ecosystem directory readers | `https://agdex.ai/` | Day 4 | Directory suggestion | Send owner-email pitch | Contact page accepts tool submissions; send owner-email pitch to agdex.ai@gmail.com |
...
| OSS AI Hub | Open-source AI tools and agents | `https://ossaihub.com/submit` | Day 4 | Directory submission | Submit from owner browser | JavaScript submission page; submissions are reviewed for quality, relevance, and community value |
...
| AgentsTide | AI agents and browser-agent directory | `https://agentstide.com/` | Day 4 | Directory suggestion | Use Submit Free Listing or owner email | Browser Agents category is a clear fit; use hello@agentstide.com if the listing form needs an email fallback |
| BuilderAI Tools | Open-source AI developer tools | `https://builderai.tools/submit` | Day 4 | Directory submission | Submit from owner email | Submit Tool for Review form; use AI Observability & Evaluation; limit is 3 submissions per day |
| 4agent.dev | Developers browsing tools built for AI agents | `https://4agent.dev/submit` | Day 4 | Directory submission | Submit from owner browser | Submit Tool form is visible; use Observability or Browser category, and tags such as browser agents, debugging, Playwright, tracing |
| CLIHunt | AI agent and developer-tool registry readers | `https://clihunt.dev/` | Day 4+ | Directory submission | Submit from owner account/form | Submit Tool form accepts name, tagline, GitHub URL, category, and install command; use category Other if no developer-tools category is available |
| DeepYard | OSS-first AI agent and developer-tool directory readers | `https://deepyard.dev/submit` | Day 4+ | Directory submission | Submit from owner browser | Submit a Tool page includes Dev Tools; submissions are reviewed before listing |
| OpenAgent.bot | Open AI stack project directory readers | `https://openagent.bot/submit/` | Day 4+ | Directory submission | Submit from owner browser | Submit as Tools; source links, repo, license, docs, and use-case details matter |
| ForgeIndex | Open-source local AI project builders | `https://forgeindex.ai/` | Day 4+ | Directory submission | Submit from owner browser | Official form; Local Agents & Automation is the cleanest fit |
| AgentShelf | AI agent and tool directory visitors | `https://www.agentshelf.io/submit` | Day 4+ | Directory submission | Submit from owner account | List your AI tool path requires sign-up; use Coding & Development or Autonomous Agents |
...
- For community replies, share the live walkthrough first. Use the PyPI `uvx`
  command only when someone asks how to run it locally.
