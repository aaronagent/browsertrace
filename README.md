...
- The live static demo and public-safe demo export let you inspect a trace before installing anything; open the [live static demo](https://aaronlab.github.io/browsertrace/) or download [`browsertrace-demo-public.html`](https://github.com/aaronlab/browsertrace/releases/download/v0.1.18/browsertrace-demo-public.html).
...
- The v0.1.18 release notes summarize what changed in the current release; read the [v0.1.18 release notes](https://github.com/aaronlab/browsertrace/releases/tag/v0.1.18).
...
[v0.1.18 release notes](https://github.com/aaronlab/browsertrace/releases/tag/v0.1.18).
...
[`browsertrace-demo.html`](https://github.com/aaronlab/browsertrace/releases/download/v0.1.18/browsertrace-demo.html)
or the public-safe
[`browsertrace-demo-public.html`](https://github.com/aaronlab/browsertrace/releases/download/v0.1.18/browsertrace-demo-public.html)
from the latest release.

For a walkthrough, read
[How to debug a Browser Use failure](https://aaronlab.github.io/browsertrace/debug-browser-agent-failure.html).
...
For the small, issue-based contribution path, local checks, and
[First PR Recipe](CONTRIBUTING.md#first-pr-recipe), read [CONTRIBUTING.md](CONTRIBUTING.md).
The recipe keeps your first contribution small and reviewable.
...
2. Pick from the [good first issue queue](https://github.com/aaronlab/browsertrace/labels/good%20first%20issue)
   for small documentation or example tasks.
